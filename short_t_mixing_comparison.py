...
PATHS = ["/home/marius/PhD/CellMotility/agent_simulation/new_output/short_t/adhesion/areaFraction_0.5_Pe_120",
         "/home/marius/PhD/CellMotility/agent_simulation/new_output/short_t/turnAround/areaFraction_0.5_Pe_120",
         "/home/marius/PhD/CellMotility/agent_simulation/new_output/short_t/turnAround_adhesion/areaFraction_0.5_Pe_120",
         "/home/marius/PhD/CellMotility/agent_simulation/new_output/short_t/turnAround_persistence/areaFraction_0.5_Pe_120"]


LABELS = ["adhesion", "turnAround", "turnAround_adhesion", "turnAround_persistence"]

FOLDER = "/home/marius/PhD/CellMotility/agent_simulation/new_output/short_t/A_0.5_Pe_120_"
...
for labelIdx, paramFile in enumerate(PATHS): 
    ...
    ax_all.plot(measurementTimes, avrMaxClusterSize, label=LABELS[labelIdx])
    ax_green.plot(measurementTimes, avrMaxClusterSizeGreen, label=LABELS[labelIdx])
    ax_red.plot(measurementTimes, avrMaxClusterSizeRed, label=LABELS[labelIdx])
...
ax_green.legend(); ax_green.set_xlabel("Time"); ax_green.set_ylabel("Avr max cluster size"); ax_green.set_title("Green clusters")
# ax_green.set_xscale("log")
# ax_green.set_yscale("log")
ax_red.legend(); ax_red.set_xlabel("Time"); ax_red.set_ylabel("Avr max cluster size"); ax_red.set_title("Red clusters")
...
fig_all.savefig(FOLDER+"max_cluster_sizes.png", format='png',dpi=300)
fig_green.savefig(FOLDER+"max_cluster_sizes_green.png", format='png',dpi=300)
fig_red.savefig(FOLDER+"max_cluster_sizes_red.png", format='png',dpi=300)

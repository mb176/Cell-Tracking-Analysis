...
"""
Calculates the mixing index for the experimental data and plots it.
"""
...
#     t =green.find_t_max()
    ...
    for t in times:
            mixingIdx, mixingIdxGreen, mixingIdxRed = calculate_mixing_index([green,red], t, NEIGHBOURS_DISTANC)
